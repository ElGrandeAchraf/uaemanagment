...
!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        : "function" == typeof define && define.amd
            ...
            : ((e = e || self), t((e.FullCalendarDayGrid = {}), e.FullCalendar));
})(this, function (e, t) {
    "use strict";
    function r(e, t) {
        function r() {
    ...
    function n(e, t) {
        ...
        for (r = 0; r < t.length; r++)
            if (((n = t[r]), n.firstCol <= e.lastCol && n.lastCol >= e.firstCol))
                return !0;
        return !1;
    }
    function i(e, t) {
    ...
    ***************************************************************************** */
    var l = function (e, t) {
        ...
        d = (function (e) {
            ...
            return (
                r(n, e),
                    (n.prototype.buildRenderRange = function (r, n, i) {
                        var o,
                            s = this.dateEnv,
                        ...
                        if (
                            ...
                            ((a = s.startOfWeek(a)),
                                (o = s.startOfWeek(d)),
                            o.valueOf() !== d.valueOf() && (d = t.addWeeks(o, 1))),
        ...
        h = (function (e) {
            ...
            return (
                r(n, e),
                    (n.prototype.renderSegHtml = function (e, r) {
                        var n,
                            i,
                            ...
                            c = a.startEditable,
                            h =
                                d && e.isStart && a.durationEditable && o.eventResizableFromStart,
                        ...
                        return (
                            ...
                            (g = '<span class="fc-time">' + t.htmlEscape(n) + "</span>"),
                                (i =
                                    '<span class="fc-title">' +
        ...
        p = (function (e) {
            ...
            return (
                r(o, e),
                    (o.prototype.attachSegs = function (e, t) {
                    ...
                    (o.prototype.renderSegRow = function (e, r) {
                            ...
                            for (; s < e; )
                                (c = (b[i - 1] || [])[s]),
                                    c
                                        ...
                                        : ((c = document.createElement("td")), l.appendChild(c)),
                                    (v[i][s] = c),
                                    (b[i][s] = c),
                                    s++;
                        }
                        ...
                        for (i = 0; i < g; i++) {
                            ...
                            C && (h.isRtl ? t.appendToElement(l, C) : t.prependToElement(l, C)),
                                m.appendChild(l);
                        }
                        return {
                            row: e,
                    ...
                    (o.prototype.buildSegLevels = function (e) {
                        ...
                        for (e = this.sortEventSegs(e), t = 0; t < e.length; t++) {
                            ...
                            (r.level = o),
                                (r.leftCol = l ? a - 1 - r.lastCol : r.firstCol),
                                (r.rightCol = l ? a - 1 - r.firstCol : r.lastCol),
                                (d[o] || (d[o] = [])).push(r);
                        }
        ...
        u = (function (e) {
            ...
            return (
                r(n, e),
                    (n.prototype.attachSegs = function (e, r) {
                        var n = r.sourceSeg,
        ...
        f = (function (e) {
            ...
            return (
                r(n, e),
                    (n.prototype.renderSegs = function (t, r) {
                        "bgEvent" === t &&
                    ...
                    (n.prototype.renderFillRow = function (e, r) {
                        ...
                        h > 0 && t.appendToElement(o, new Array(h + 1).join("<td></td>")),
                            (r.el.colSpan = p - h),
                            o.appendChild(r.el),
                        p < l &&
                        t.appendToElement(o, new Array(l - p + 1).join("<td></td>"));
                        var u = s.renderProps.renderIntroHtml();
                        return (
                            u && (s.isRtl ? t.appendToElement(o, u) : t.prependToElement(o, u)),
                                i
                        );
                    }),
                    n
        ...
        v = t.createFormatter({ day: "numeric" }),
        ...
        w = (function (e) {
            function n(r, n, i) {
                ...
                var a = (o.renderCells = t.memoizeRendering(
                    o._renderCells,
                    o._unrenderCells
                ));
                return (
                ...
                r(n, e),
                    ...
                    (n.prototype.renderNumberCellHtml = function (e) {
                        ...
                        return d || this.renderProps.cellWeekNumbersVisible
                            ? ((r = t.getDayClasses(e, this.props.dateProfile, this.context)),
                                r.unshift("fc-day-top"),
                            this.renderProps.cellWeekNumbersVisible && (n = s.weekDow),
                                (l +=
                                    '<td class="' +
                                    r.join(" ") +
                                    '"' +
                    ...
                    (n.prototype.limitRow = function (e, r) {
                        var n,
                            ...
                            H = function (n) {
                                for (; R < n; )
                                    (a = v.getCellSegs(e, R, r)),
                                    a.length &&
                                    ((h = i[r - 1][R]),
                                        (y = v.renderMoreLink(e, R, a)),
                        ...
                        if (r && r < C.segLevels.length) {
                            for (
                                n = C.segLevels[r - 1],
                                    i = C.cellMatrix,
                                    o = t.findChildren(C.tbodyEl).slice(r),
                                ...
                                for (H(D), c = [], d = 0; R <= P; )
                                    (a = this.getCellSegs(e, R, r)),
                                        c.push(a),
                                        (d += a.length),
                                        R++;
                                if (d) {
                                    for (
                                        h = i[r - 1][D], p = h.rowSpan || 1, u = [], f = 0;
                                        f < c.length;
                                        f++
                                    )
                                        (g = t.createElement("td", {
                                            ...
                                            (a = c[f]),
                                            (y = this.renderMoreLink(e, D + f, [l].concat(a))),
                                            (m = t.createElement("div", null, y)),
                                            g.appendChild(m),
                                            u.push(g),
                                            E.push(g);
                        ...
                        return (
                            (a.innerText = this.getMoreLinkText(n.length)),
                                a.addEventListener("click", function (t) {
                                    ...
                                    "function" == typeof o &&
                                    (o = i.publiclyTrigger("eventLimitClick", [
                                        {
                                            date: l.toDate(d),
                                            allDay: !0,
                                            dayEl: h,
                                        ...
                                        "popover" === o
                                            ...
                                            : "string" == typeof o && s.calendar.zoomTo(d, o);
                                }),
                                a
                        );
                    }),
                    (n.prototype.showSegPopover = function (e, r, n, i) {
                        ...
                        (o = 1 === this.rowCnt ? h.el : this.rowEls[e]),
                            (s = {
                                ...
                                autoHide: !0,
                                content: function (t) {
                                    (l.segPopoverTile = new g(l.context, t)),
                                        l.updateSegPopoverTile(l.props.cells[e][u].date, i);
                                },
                                hide: function () {
                            ...
                            this.isRtl
                                ? (s.right = t.computeRect(f).right + 1)
                                : (s.left = t.computeRect(f).left - 1),
                            (this.segPopover = new c(s)),
                ...
                return (
                    s.opt("weekNumbers")
                        ? s.opt("weekNumbersWithinDays")
                            ? ((d = !0), (s.colWeekNumbersVisible = !1))
                            : ((d = !1), (s.colWeekNumbersVisible = !0))
                        : ((s.colWeekNumbersVisible = !1), (d = !1)),
                        (s.dayGrid = new w(s.context, a, {
    ...
    var E = (function (e) {
                ...
                r(t, e),
                    ...
                    (t.prototype.render = function (e) {
                        var t = this.dayGrid,
                            ...
                            n = e.dayTable;
                        t.receiveProps(
                            a({}, this.slicer.sliceProps(e, r, e.nextDayThreshold, t, n), {
                                dateProfile: r,
                                cells: n.cells,
                                isRigid: e.isRigid,
                            })
        ...
        H = (function (e) {
            function n(r, n, i, o) {
                ...
                return (
                    (l.buildDayTable = t.memoize(s)),
                    l.opt("columnHeader") &&
                    (l.header = new t.DayHeader(
                        l.context,
                        l.el.querySelector(".fc-head-container")
                    )),
                        (l.simpleDayGrid = new E(l.context, l.dayGrid)),
                        l
                );
            }
            return (
    ...
    (e.default = D),
        ...
        (e.DayGridSlicer = R),
        (e.DayGrid = w),
        (e.AbstractDayGridView = C),
        (e.DayGridView = H),
        (e.buildBasicDayTable = s),
        (e.DayBgRow = y),
