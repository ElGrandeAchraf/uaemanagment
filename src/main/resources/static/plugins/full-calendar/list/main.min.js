...
!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        : "function" == typeof define && define.amd
            ...
            : ((e = e || self), t((e.FullCalendarList = {}), e.FullCalendar));
})(this, function (e, t) {
    "use strict";
    function n(e, t) {
        function n() {
    ...
    function r(e) {
        for (
            ...
            s.push(n),
                a.push({ start: n, end: t.addDays(n, 1) }),
                (n = t.addDays(n, 1));
    ...
    var s = function (e, t) {
        ...
        i = (function (e) {
            function s(n, s, i, o) {
                ...
                (l.computeDateVars = t.memoize(r)),
                    (l.eventStoreToSegs = t.memoize(l._eventStoreToSegs));
                var d = (l.eventRenderer = new a(l));
                (l.renderContent = t.memoizeRendering(
                    d.renderSegs.bind(d),
                    d.unrender.bind(d)
                )),
                    l.el.classList.add("fc-list-view");
                for (
                    var c = (l.theme.getClass("listView") || "").split(" "), p = 0, h = c;
                    p < h.length;
                    p++
                ) {
                    var u = h[p];
                ...
                return (
                    (l.scroller = new t.ScrollComponent("hidden", "auto")),
                        l.el.appendChild(l.scroller.el),
                        (l.contentEl = l.scroller.el),
                        n.calendar.registerInteractiveComponent(l, { el: l.el }),
                        l
                );
            }
            return (
                n(s, e),
                    ...
                    (s.prototype.renderSegList = function (e) {
                        ...
                        for (n = 0; n < a.length; n++)
                            if ((r = a[n]))
                                for (
                                    o.appendChild(this.buildDayHeaderRow(this.dayDates[n])),
                                        r = this.eventRenderer.sortEventSegs(r),
                                        s = 0;
                                    s < r.length;
                                    s++
                                )
                                    o.appendChild(r[s].el);
