...
!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        : "function" == typeof define && define.amd
            ...
            : ((e = e || self), t((e.FullCalendarInteraction = {}), e.FullCalendar));
})(this, function (e, t) {
    "use strict";
    function n(e, t) {
        function n() {
    ...
    function g(e, n, r) {
        ...
        for (
            var d = { startDelta: c, endDelta: c, standardProps: s }, u = 0, g = r;
            u < g.length;
            u++
        ) {
            (0, g[u])(d, e, n);
    ...
    function p(e, n, r, i, o) {
        for (
            var a = e.component.dateEnv,
                l = e.dateSpan.range.start,
                s = n.dateSpan.range.start,
                c = t.diffDates(l, s, a, e.component.largeUnit),
                d = {},
                u = 0,
                g = o;
            u < g.length;
    ...
    function v(e, n, r) {
        for (
            var i = S({}, n.leftoverProps),
                o = 0,
                a = r.pluginSystem.hooks.externalDefTransforms;
            o < a.length;
            o++
        ) {
            var l = a[o];
        ...
        var s = t.parseEventDef(i, n.sourceId, e.allDay, Boolean(n.duration), r),
            c = e.range.start;
        e.allDay && n.startTime && (c = r.dateEnv.add(c, n.startTime));
        var d = n.duration
            ? r.dateEnv.add(c, n.duration)
            : r.getDefaultEventEnd(e.allDay, c);
        return {
            def: s,
            instance: t.createEventInstance(s.defId, { start: c, end: d }),
        };
    }
    function f(e) {
        var n = E(e, "event"),
    ...
    ***************************************************************************** */
            ...
            function e(e) {
                ...
                (this.subjectEl = null),
                    ...
                    (this.handleTouchEnd = function (e) {
                        if (n.isDragging) {
                            var t = e.target;
                            t.removeEventListener("touchmove", n.handleTouchMove),
                                t.removeEventListener("touchend", n.handleTouchEnd),
                                t.removeEventListener("touchcancel", n.handleTouchEnd),
                ...
                (e.prototype.start = function (e, t) {
                    ...
                    (e.prototype.computeBestEdge = function (e, t) {
                        for (
                            ...
                            a.canScrollDown() &&
                            (!r || r.distance > u) &&
                            (r = { scrollCache: a, name: "bottom", distance: u }),
                            s <= n &&
                            this.everMovedLeft &&
                            a.canScrollLeft() &&
                            (!r || r.distance > s) &&
            ...
            return (
                (e.prototype.destroy = function () {
                    ...
                    (e.prototype.isWithinClipping = function (e, n) {
                        for (
                            var r = { left: e, top: n }, i = 0, o = this.scrollCaches;
                            i < o.length;
                            i++
                        ) {
                            var a = o[i];
                            if (!s(a.getEventTarget()) && !t.pointInsideRect(r, a.clientRect))
                                return !1;
                        }
                        return !0;
                    }),
        ...
        N = (function (e) {
            function r(n) {
                ...
                (r.dragSelection = null),
                    ...
                    (r.handleHitUpdate = function (e, n) {
                        ...
                        (((o = u(
                                    ...
                                    e,
                                    i.pluginSystem.hooks.dateSelectionTransformers
                                )) &&
                                r.component.isDateSelectionValid(o)) ||
                            ((a = !0), (o = null))),
                            o
                                ? i.dispatch({ type: "SELECT_DATES", selection: o })
                                : n || i.dispatch({ type: "UNSELECT_DATES" }),
                ...
                (o.touchScrollAllowed = !1),
                    (o.minDistance = i.opt("selectMinDistance") || 0),
                    (o.autoScroller.isEnabled = i.opt("dragScroll"));
                var a = (r.hitDragging = new A(
                    r.dragging,
                    t.interactionSettingsToStore(n)
                ));
                return (
        ...
        V = (function (e) {
            function r(n) {
                ...
                (i.subjectSeg = null),
                    (i.isDragging = !1),
                    (i.eventRange = null),
                    (i.relevantEvents = null),
                    (i.receivingCalendar = null),
                    (i.validMutation = null),
                    (i.mutatedRelevantEvents = null),
                    (i.handlePointerDown = function (e) {
                        ...
                        (i.relevantEvents = t.getRelevantEvents(s.state.eventStore, u)),
                            (a.minDistance = e.isTouch ? 0 : o.opt("eventDragMinDistance")),
                            (a.delay =
                                e.isTouch && u !== o.props.eventSelection ? h(o) : null),
                            (l.parentNode = s.el),
                            (l.revertDuration = o.opt("dragRevertDuration"));
                        var g =
                            o.isValidSegDownEl(n) && !t.elementClosest(n, ".fc-resizer");
                        a.setIgnoreMove(!g),
                            (i.isDragging =
                    ...
                    (i.handleDragStart = function (e) {
                        ...
                        e.isTouch
                            ? o !== i.component.props.eventSelection &&
                            n.dispatch({ type: "SELECT_EVENT", eventInstanceId: o })
                    ...
                    (i.handleHitUpdate = function (e, n) {
                        if (i.isDragging) {
                            ...
                            if (e) {
                                var p = e.component;
                                (l = p.calendar),
                                    a === l || (p.opt("editable") && p.opt("droppable"))
                                        ? (s = g(
                                            o,
                                            e,
                                            l.pluginSystem.hooks.eventDragMutationMassagers
                                        )) &&
                                        ((d = t.applyMutationToEventStore(
                                            r,
                                            l.eventUiBases,
                                            s,
                                            l
                                            ...
                                            (h.mutatedEvents = d),
                                        i.component.isInteractionValid(h) ||
                                        ((u = !0),
                                            (s = null),
                                            (d = null),
                                            (h.mutatedEvents = t.createEmptyEventStore())))
                                        : (l = null);
                            }
                            i.displayDrag(l, h),
                            ...
                            n ||
                            (a === l && c(o, e) && (s = null),
                                i.dragging.setMirrorNeedsRevert(!s),
                                i.dragging.setMirrorIsVisible(
                                    !e || !document.querySelector(".fc-mirror")
                                ),
                                (i.receivingCalendar = l),
                                (i.validMutation = s),
                                (i.mutatedRelevantEvents = d));
                        }
                    }),
                    ...
                    (i.handleDragEnd = function (e) {
                        if (i.isDragging) {
                            ...
                            if (
                                ...
                                if (o === n) {
                                    n.dispatch({ type: "MERGE_EVENTS", eventStore: d });
                                    for (
                                        var g = {},
                                            h = 0,
                                            p = n.pluginSystem.hooks.eventDropTransformers;
                                        h < p.length;
                                        h++
                                    ) {
                                        var v = p[h];
                                    ...
                                    (f.draggedEl = e.subjectEl),
                                        (f.jsEvent = e.origEvent),
                                        (f.view = u.component),
                                        o.publiclyTrigger("drop", [f]),
                ...
                return (
                    (l.useSubjectCenter = n.useEventCenter),
                        l.emitter.on("pointerdown", i.handlePointerDown),
                        l.emitter.on("dragstart", i.handleDragStart),
                        l.emitter.on("hitupdate", i.handleHitUpdate),
                        l.emitter.on("pointerup", i.handlePointerUp),
                        l.emitter.on("dragend", i.handleDragEnd),
                        i
                );
            }
            return (
            ...
            function r(n) {
                ...
                (r.draggingSeg = null),
                    ...
                    (r.handleHitUpdate = function (e, n, i) {
                        ...
                        d &&
                        ((u = t.applyMutationToEventStore(a, o.eventUiBases, d, o)),
                            (h.mutatedEvents = u),
                        r.component.isInteractionValid(h) ||
                        ((g = !0), (d = null), (u = null), (h.mutatedEvents = null))),
                            u
                                ? o.dispatch({ type: "SET_EVENT_RESIZE", state: h })
                                : o.dispatch({ type: "UNSET_EVENT_RESIZE" }),
                            g ? t.disableCursor() : t.enableCursor(),
                        n ||
                        (d && c(l, e) && (d = null),
                            (r.validMutation = d),
                            (r.mutatedRelevantEvents = u));
                    }),
                    (r.handleDragEnd = function (e) {
                        var n = r.component.calendar,
                            i = r.component.view,
                ...
                (this.isRecentPointerDateSelect = !1),
                    ...
                    (this.onDocumentPointerUp = function (e) {
                        ...
                        if (!o.wasTouchScroll) {
                            ...
                            a.eventSelection &&
                            !t.elementClosest(o.downEl, V.SELECTOR) &&
            ...
            function e(e, n) {
                ...
                (this.receivingCalendar = null),
                    ...
                    (this.handleHitUpdate = function (e, n, i) {
                        ...
                        r.canDropElOnCalendar(i.subjectEl, a) &&
                        ((l = v(e.dateSpan, r.dragMeta, a)),
                            (c.mutatedEvents = t.eventTupleToStore(l)),
                        (s = !t.isInteractionValid(c, a)) &&
                        ((c.mutatedEvents = t.createEmptyEventStore()), (l = null)))),
                            r.displayDrag(a, c),
                            o.setMirrorIsVisible(
                                n || !l || !document.querySelector(".fc-mirror")
                            ),
                            s ? t.disableCursor() : t.enableCursor(),
                        n ||
    ...
    (e.default = W),
        (e.FeaturefulElementDragging = L),
        (e.PointerDragging = T),
        (e.Draggable = U),
        (e.ThirdPartyDraggable = q),
