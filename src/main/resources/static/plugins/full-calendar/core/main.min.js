...
!(function (e, t) {
    ...
    function Je(e, t) {
        ...
        return (
            e.start && ((n = X(e.start)), r && r <= n && (r = V(n, 1))),
                { start: n, end: r }
        );
    }
    function Ke(e) {
    ...
    function et(e, t, n, r) {
        var i = r[e.recurringDef.typeId],
            o = i.expand(e.recurringDef.typeData, e, t, n);
    ...
    function lt(e, t, n) {
        ...
        for (var a in i) {
            var s = i[a];
            if (s.recurringDef) {
                var u = et(s, t, n.dateEnv, n.pluginSystem.hooks.recurringTypes),
    ...
    function vt(e, t) {
        return {
            defs: Di({}, e.defs, t.defs),
            instances: Di({}, e.instances, t.instances),
        };
    }
    function gt(e, t) {
        var n = rt(e.defs, t),
    ...
    function mt(e, t) {
        var n,
            ...
            i = [],
            o = t.start;
        for (e.sort(Et), n = 0; n < e.length; n++)
            (r = e[n]),
    ...
    function xt(e, t, n, r, i) {
        return (
            ...
            r.omitCommas && (e = e.replace(Ri, "").trim()),
            r.omitZeroMinute && (e = e.replace(":00", "")),
                !1 === r.meridiem
                    ? (e = e.replace(wi, "").trim())
                    : "narrow" === r.meridiem
                        ? (e = e.replace(wi, function (e, t) {
    ...
    function Vt(e, t) {
        return "object" == typeof e && e
            ? ("string" == typeof t && (e = Di({ separator: t }, e)), new ki(e))
            : "string" == typeof e
                ? new Oi(e, t)
                : "function" == typeof e
                    ? new _i(e)
    ...
    function jt(e, t, n, r) {
        ...
        for (var m in i)
            for (var E = i[m], S = mt(E, n), D = 0, T = S; D < T.length; D++) {
                var b = T[D],
                    d = a[m],
                    h = l[d.defId];
                s.push({
        ...
        for (var c in o)
            for (var E = o[c], S = mt(E, n), w = 0, R = S; w < R.length; w++) {
                var b = R[w];
                s.push({
                    def: e.defs[c],
                    ui: l[c],
    ...
    function $t(e, t, n, r, i) {
        ...
        null == o.hasEnd &&
        t.durationEditable &&
        en(t.startEditable ? n.startDelta : null, n.endDelta || null) &&
        (o.hasEnd = !0);
        ...
        return (
            ...
            (u.range = {
                ...
                s
                    ...
                    : !r.endDelta ||
                    (!n.durationEditable &&
                        en(n.startEditable ? r.startDelta : null, r.endDelta)) ||
                    (u.range = {
                        start: u.range.start,
    ...
    function pn(e, t, n, r) {
        return (
            void 0 === n && (n = {}),
            !(e.eventDrag && !hn(e, t, n, r)) && !(e.dateSelection && !vn(e, t, n, r))
        );
    }
    function hn(e, t, n, r) {
        var i = e.eventDrag,
        ...
        r && (u = it(u, r));
        var l = ln(e.eventStore, i.affectedEvents.instances),
            c = l.defs,
            d = l.instances,
            f = Jt(c, e.eventUiBases);
        for (var p in s) {
            var h = s[p],
                v = h.range,
                g = u[h.defId],
            ...
            for (var D = 0, T = g.allows; D < T.length; D++) {
                var b = T[D],
                    w = e.eventStore.defs[y.defId],
                    R = e.eventStore.instances[p],
    ...
    function vn(e, t, n, r) {
        var i = e.eventStore,
            ...
            u = s.range,
            l = t.selectionConfig;
        if ((r && (l = r(l)), !gn(l.constraints, u, i, e.businessHours, t)))
            return !1;
    ...
    function kn(e, t, n, r) {
        var i = Nn(t, n),
            o = {},
            a = $e(e, i, n.dateEnv, n.pluginSystem.hooks.recurringTypes, o);
        if (a) {
        ...
        if (l) {
            ...
            return {
                def: s,
                instance: _n(s.defId, l.range, l.forcedStartTzo, l.forcedEndTzo),
            };
        }
        return null;
    }
    function On(e, t, n, r, i) {
        ...
        return (
            (a.extendedProps = Di(o, a.extendedProps || {})),
    ...
    function nr(e) {
        for (
            var t = window.FullCalendarLocalesAll || [],
            ...
            "string" == typeof a
                ? n[a]
                    ? r.push(n[a])
                    : console.warn("You must have " + a + ".js locale file loaded.")
                : r.push(a);
        }
        for (
            var s = r.length ? r[0].code : "en",
                u = { en: vo },
                l = 0,
                c = r.concat(t);
            l < c.length;
    ...
    function ur(e) {
        ...
        ((n = !r[1]),
            n
                ? (e += "T00:00:00Z")
                : (e =
                    e.replace(So, function (e, n, r, i, o) {
                        return (
                            (t = n
                                ? 0
        ...
        var i = new Date(e);
        return ae(i)
            ? { marker: i, isTimeUnspecified: n, timeZoneOffset: t }
            : null;
    }
    function lr(e, t) {
    ...
    function fr(e, t, n, r) {
        switch (t.type) {
            ...
            case "CHANGE_TIMEZONE":
                return yr(
                    e,
                    t.sourceIds ? ot(t.sourceIds) : Sr(e, r),
    ...
    function Er(e, t, n, r) {
        ...
        return o && n === o.latestFetchId
            ? Di(
                {},
                e,
                ((i = {}), (i[t] = Di({}, o, { isFetching: !1, fetchRange: r })), i)
            )
            : e;
    }
    function Sr(e, t) {
    ...
    function Tr(e, t, n) {
        for (
            var r = br(e.viewType, t),
                i = wr(e.dateProfile, t, e.currentDate, r, n),
                o = fr(e.eventSources, t, i, n),
                a = Di({}, e, {
                    viewType: r,
                    dateProfile: i,
    ...
    function wr(e, t, n, r, i) {
        ...
        switch (t.type) {
            ...
            case "NEXT":
                ...
                break;
            case "SET_DATE":
                (e.activeRange && wt(e.currentRange, t.dateMarker)) ||
    ...
    function Rr(e, t, n) {
        switch (t.type) {
            ...
            case "SET_VIEW_TYPE":
                ...
                return n.activeRange && !wt(n.activeRange, r)
        ...
        return (
            (n = /^(year|month)$/.test(e.currentRangeUnit)
                ...
                this.dateEnv.formatRange(
                    n.start,
                    n.end,
                    Vt(t.titleFormat || qr(e), t.titleRangeSeparator),
    ...
    function ii(e, t, n) {
        var r = oi("object" == typeof n && n ? n : {}),
            i = Vt(n, co.defaultRangeSeparator),
    ...
    function oi(e) {
        ...
        return (
            (e = Di({ timeZone: co.timeZone, calendarSystem: "gregory" }, e, {
                locale: t,
            })),
                new Do(e)
        );
    ...
    function ui(e, t, n, r, i, o, a, s) {
        ...
        return (
            (u =
                ...
                n ? (h = h.concat(Fn(e, t, o, !0))) : h.push("fc-" + yi[e.getUTCDay()]),
            '<th class="' +
            h.join(" ") +
            '"' +
            (p && n
            ...
            (s ? " " + s : "") +
            ">" +
            (p ? An(l, { date: e, forceOff: !n || 1 === r }, u) : u) +
            "</th>"
        );
    }
    function li(e, t) {
        ...
        return t
            ? n
            : {
                start: A(n.start, e.minTime.milliseconds),
                end: A(n.end, e.maxTime.milliseconds - 864e5),
            };
    }
    var ci = { className: !0, colSpan: !0, rowSpan: !0 },
        di = { "<tr": "tbody", "<td": "tr" },
        fi =
        ...
        hi = /(top|left|right|bottom|width|height)$/i,
        vi = null,
        gi = [
            "webkitTransitionEnd",
            "otransitionend",
        ...
        mi = ["years", "months", "days", "milliseconds"],
        Ei = /^(-?)(?:(\d+)\.)?(\d+):(\d\d)(?::(\d\d)(?:\.(\d\d\d))?)?/,
        Si = function (e, t) {
            return (Si =
        ...
        ki = (function () {
            function e(e) {
                ...
                for (var i in e)
                    i in Ti
                        ? ((n[i] = e[i]), (r = Math.max(Ti[i], r)))
                        : ((t[i] = e[i]), i in bi && (r = Math.max(bi[i], r)));
                (this.standardDateProps = t),
                    (this.extendedSettings = n),
                    (this.severity = r),
                    (this.buildFormattingFunc = Mt(Ot));
            }
            return (
                (e.prototype.format = function (e, t) {
                    ...
                    (e.prototype.formatRange = function (e, t, n) {
                        var r = this,
                            ...
                            a = zt(e.marker, t.marker, n.calendarSystem);
                ...
                (e.prototype.setProp = function (e, t) {
                    ...
                    (e.prototype.setStart = function (e, t) {
                        ...
                        if (r && this._instance) {
                            ...
                            if (t.maintainDuration) {
                                a = ve(
                                    Qe(i.start, i.end, n, t.granularity),
                                    Qe(r, i.end, n, t.granularity)
                                );
                            }
                    ...
                    Object.defineProperty(e.prototype, "source", {
                        get: function () {
                            ...
                            return e
                                ? new Pi(this._calendar, this._calendar.state.eventSources[e])
                                : null;
                        },
                        enumerable: !0,
                        configurable: !0,
        ...
        Ui = { start: null, date: null, end: null, allDay: null },
        Li = 0,
        Vi = {
            startTime: "09:00",
            endTime: "17:00",
        ...
        Bi = (function () {
            function e() {
                (this.getKeysForEventDefs = Mt(this._getKeysForEventDefs)),
                    (this.splitDateSelection = Mt(this._splitDateSpan)),
                    (this.splitEventStore = Mt(this._splitEventStore)),
                    (this.splitIndividualUi = Mt(this._splitIndividualUi)),
                    (this.splitEventDrag = Mt(this._splitInteraction)),
                    (this.splitEventResize = Mt(this._splitInteraction)),
            ...
            return (
                tt(t, e),
                    ...
                    (t.prototype.off = function (e, t) {
                        return (
                            this._handlers && jn(this._handlers, e, t),
                            this._oneHandlers && jn(this._oneHandlers, e, t),
                                this
                        );
                    }),
    ...
    (Xi.prototype.classes = {}),
        (Xi.prototype.iconClasses = {}),
        (Xi.prototype.baseIconClass = ""),
        (Xi.prototype.iconOverridePrefix = "");
    var Ji = 0,
        Ki = (function () {
            function e(e, t) {
                t && (e.view = this),
            ...
            return (
                (e.addEqualityFuncs = function (e) {
                    this.prototype.equalityFuncs = Di(
                        {},
                    ...
                    (e.prototype.receiveProps = function (e) {
                        var t = Yn(this.props || {}, e, this.equalityFuncs),
                            n = t.anyChanges,
                            r = t.comboProps;
    ...
    (Qi.prototype.fgSegSelector = ".fc-event-container > *"),
        (Qi.prototype.bgSegSelector = ".fc-bgevent:not(.fc-nonbusiness)");
    var $i = 0,
        eo = (function () {
            function e() {
                (this.hooks = {
        ...
        so = {
            parse: function (e, t, n, r) {
                ...
                var l;
                return (
                    (l = !a.startTime && !a.endTime && (null == t || t)),
                        s
                            ? {
                                allDay: l,
                                duration:
                                    a.startTime && a.endTime ? ve(a.endTime, a.startTime) : null,
                                typeData: a,
                            }
                            : null
                );
        ...
        po = ["header", "footer", "buttonText", "buttonIcons"],
        ho = [no, io, ao, uo],
        vo = {
            code: "en",
            week: { dow: 0, doy: 4 },
                ...
                (e.prototype.add = function (e, t) {
                    ...
                    (e.prototype.compute = function () {
                        var e = Ye(
                            ...
                            n = nr(e),
                            r = rr(t || n.defaultCode, n.map).options,
    ...
    var Eo = /^\s*\d{4}-\d\d-\d\d([T ]\d)?/,
        ...
        Do = (function () {
            function e(e) {
                ...
                (this.namedTimeZoneImpl = new e.namedTimeZoneImpl(t)),
                    ...
                    (this.calendarSystem = sr(e.calendarSystem)),
        ...
        Ro = (function () {
            ...
            return (
                (e.prototype.buildPrev = function (e, t) {
                    var n = this.dateEnv,
                        r = n.subtract(t, e.dateIncrement);
                    return this.build(r, -1);
                }),
                    (e.prototype.buildNext = function (e, t) {
                        var n = this.dateEnv,
                            r = n.add(t, e.dateIncrement);
                        return this.build(r, 1);
                    }),
                    (e.prototype.build = function (e, t, n) {
                        ...
                        return (
                            ...
                            n && (e = Rt(e, r)),
                                ...
                                (s = a),
                            this.options.showNonCurrentDates || (s = St(s, i.range)),
                    ...
                    (e.prototype.adjustActiveRange = function (e, t, n) {
                        ...
                        return (
                            ...
                            Ee(n) > 1 && ((o = X(o)), (o = V(o, -1)), (o = r.add(o, n)))),
                                { start: i, end: o }
                        );
                    }),
                    (e.prototype.buildRangeFromDuration = function (e, t, n, r) {
                        ...
                        return (
                            ...
                            ((o = this.options.dateIncrement),
                                o
                                    ? ((a = ue(o)), (d = Te(a) < Te(n) ? we(a, !de(o)).unit : r))
                                    : (d = r)),
                            Ee(n) <= 1 &&
                            this.isHiddenDay(s) &&
        ...
        Co = { type: String, class: null },
        Mo = (function (e) {
            function r(n, r) {
                var i = e.call(this, n) || this;
                return (
                    (i._renderLayout = Ln(i.renderLayout, i.unrenderLayout)),
                        (i._updateTitle = Ln(i.updateTitle, null, [i._renderLayout])),
                        (i._updateActiveButton = Ln(i.updateActiveButton, null, [
                            i._renderLayout,
                        ])),
                        (i._updateToday = Ln(i.updateToday, null, [i._renderLayout])),
        ...
        ko = (function (e) {
            function n(n, r) {
                var i = e.call(this, n) || this;
                (i._renderToolbars = Ln(i.renderToolbars)),
                    (i.buildViewPropTransformers = Mt(Gr)),
                    (i.el = r),
                ...
                return (
                    i.toggleElClassNames(!0),
                        (i.computeTitle = Mt(Yr)),
                        (i.parseBusinessHours = Mt(function (e) {
            ...
            return (
                tt(n, e),
                    ...
                    (n.prototype.renderToolbars = function (e, t, n, r, i) {
                        ...
                        o
                            ? (this.header ||
                            ((this.header = new Mo(this.context, "fc-header-toolbar")),
                                s(this.el, this.header.el)),
                                this.header.receiveProps(Di({ layout: o }, p)))
                            : this.header && (this.header.destroy(), (this.header = null)),
                            u
                                ? (this.footer ||
                                ((this.footer = new Mo(this.context, "fc-footer-toolbar")),
                                    a(this.el, this.footer.el)),
                                    this.footer.receiveProps(Di({ layout: u }, p)))
    ...
    var No = (function () {
        function e(e, t) {
            var n = this;
            (this.parseRawLocales = Mt(nr)),
                (this.buildLocale = Mt(rr)),
                (this.buildDateEnv = Mt(Kr)),
                (this.buildTheme = Mt(Qr)),
                (this.buildEventUiSingleBase = Mt(this._buildEventUiSingleBase)),
                (this.buildSelectionConfig = Mt(this._buildSelectionConfig)),
                (this.buildEventUiBySource = kt(ei, at)),
                (this.buildEventUiBases = Mt(ti)),
                ...
                (this.buildDelayedRerender = Mt($r)),
                (this.afterSizingTriggers = {}),
                (this.isViewUpdated = !1),
                (this.isDatesUpdated = !1),
                (this.isEventsUpdated = !1),
                (this.el = e),
                (this.optionsManager = new go(t || {})),
                (this.pluginSystem = new eo());
            for (
                var r = tr(this.optionsManager.computed.plugins || []), i = 0, o = r;
                i < o.length;
                i++
            ) {
                var a = o[i];
            ...
            Object.defineProperty(e.prototype, "view", {
                    ...
                    this.optionsManager.add(e, t),
                        ...
                        "height" === e || "contentHeight" === e || "aspectRatio" === e
                            ...
                            ((this.needsFullRerender = !0),
                                this.batchRendering(function () {
                                    "timeZone" === e &&
                                    n.dispatch({ type: "CHANGE_TIMEZONE", oldDateEnv: r }),
                                        n.dispatch({
                                            type: "SET_VIEW_TYPE",
                ...
                (e.prototype.handleOptions = function (e) {
                    ...
                    (this.dateEnv = this.buildDateEnv(
                        ...
                        (this.viewSpecs = Zr(n.views, this.optionsManager)),
                        (this.dateProfileGenerators = it(this.viewSpecs, function (e) {
                ...
                (e.prototype._buildEventUiSingleBase = function (e) {
                    return (
                        e.editable && (e = Di({}, e, { eventEditable: !0 })),
                            In("event", e, this)
                    );
                }),
                ...
                (e.prototype.addEvent = function (e, t) {
                    ...
                    var i;
                    if (t instanceof Pi) i = t.internalEventSource.sourceId;
                    else if (null != t) {
                    ...
                    var a = kn(e, i, this);
                    return a
                        ? (this.dispatch({ type: "ADD_EVENTS", eventStore: ut(a) }),
                            new xi(this, a.def, a.def.recurringDef ? null : a.instance))
                        : null;
                }),
    ...
    var zo = (function (e) {
        function n(n, r, i, o) {
            ...
            return (
                (a.renderDatesMem = Ln(a.renderDatesWrap, a.unrenderDatesWrap)),
                    (a.renderBusinessHoursMem = Ln(
                        a.renderBusinessHours,
                        a.unrenderBusinessHours,
                        [a.renderDatesMem]
                    )),
                    (a.renderDateSelectionMem = Ln(
                        a.renderDateSelectionWrap,
                        a.unrenderDateSelectionWrap,
                        [a.renderDatesMem]
                    )),
                    (a.renderEventsMem = Ln(a.renderEvents, a.unrenderEvents, [
                        a.renderDatesMem,
                    ])),
                    (a.renderEventSelectionMem = Ln(
                        a.renderEventSelectionWrap,
                        a.unrenderEventSelectionWrap,
                        [a.renderEventsMem]
                    )),
                    (a.renderEventDragMem = Ln(
                        a.renderEventDragWrap,
                        a.unrenderEventDragWrap,
                        [a.renderDatesMem]
                    )),
                    (a.renderEventResizeMem = Ln(
        ...
        return (
            tt(n, e),
                ...
                (n.prototype.applyScroll = function (e, t) {
                    e.isDateInit &&
                    (delete e.isDateInit,
                    this.props.dateProfile && Di(e, this.computeInitialDateScroll())),
    ...
    Wi.mixInto(zo),
        ...
        (zo.prototype.dateProfileGeneratorClass = Ro);
    var Uo = (function () {
            function e(e) {
                ...
                (e.prototype.getSegsByType = function (e) {
                    ...
                    (e.prototype.renderSegEls = function (e, t) {
                        ...
                        if (t.length) {
                            ...
                            "bgEvent" === e && (t = qt(this.context.view, t, !1)),
        ...
        Bo = { startTime: ue, duration: ue, create: Boolean, sourceId: String },
        Fo = { create: !0 },
        Wo = (function (e) {
            function t(t, r) {
            ...
            return (
                tt(t, e),
                    ...
                    (t.prototype.render = function (e) {
                        ...
                        for (
                            var i = Vt(this.opt("columnHeaderFormat") || si(n, t.length)),
                                o = 0,
                                a = t;
                            o < a.length;
                            o++
        ...
        Yo = (function () {
            function e() {
                (this.sliceBusinessHours = Mt(this._sliceBusinessHours)),
                    (this.sliceDateSelection = Mt(this._sliceDateSpan)),
                    (this.sliceEventStore = Mt(this._sliceEventStore)),
                ...
                (e.prototype.sliceProps = function (e, t, n, r) {
                    ...
                    (e.prototype.sliceNowDate = function (e, t) {
                        ...
                        return this._sliceDateSpan.apply(
                            this,
                            [{ range: { start: e, end: A(e, 1) }, allDay: !1 }, {}, t].concat(n)
                        );
                    }),
                    (e.prototype._sliceBusinessHours = function (e, t, n, r) {
                        ...
                        return e
                            ? this._sliceEventStore.apply(
                                this,
                                [lt(e, li(t, Boolean(n)), r.calendar), {}, t, n, r].concat(i)
                            ).bg
                            : [];
                    }),
    ...
    (e.version = "4.0.1"),
        (e.parseEventDef = On),
        (e.createEventInstance = _n),
        (e.parseBusinessHours = zn),
        (e.applyAll = je),
        (e.debounce = qe),
        (e.padStart = Fe),
        (e.isInt = Ze),
        ...
        (e.elementClosest = d),
        (e.forceClassName = v),
        (e.filterEventStoreDefs = gt),
        (e.createEmptyEventStore = ht),
        (e.mergeEventStores = vt),
        (e.getRelevantEvents = ct),
        (e.eventTupleToStore = ut),
        (e.processScopedUiProps = In),
        (e.combineEventUis = Cn),
        (e.Splitter = Bi),
        (e.buildGotoAnchorHtml = An),
        (e.getAllDayHtml = Bn),
        (e.getDayClasses = Fn),
        (e.preventDefault = H),
        ...
        (e.computeClippingRect = x),
        (e.computeRect = k),
        (e.unpromisify = Wn),
        (e.EmitterMixin = Wi),
        (e.rangeContainsMarker = wt),
        (e.intersectRanges = St),
        (e.rangesEqual = Dt),
        (e.rangesIntersect = Tt),
        (e.rangeContainsRange = bt),
        (e.Mixin = Fi),
        (e.PositionCache = Zi),
        (e.ScrollComponent = Gi),
        (e.ScrollController = ji),
        (e.ElementScrollController = Yi),
        (e.WindowScrollController = qi),
        (e.Theme = Xi),
        (e.Component = Ki),
        (e.DateComponent = Qi),
        (e.Calendar = No),
        (e.View = zo),
        (e.FgEventRenderer = Uo),
        (e.buildSegCompareObj = ni),
        (e.FillRenderer = Lo),
        (e.DateProfileGenerator = Ro),
    ...
    (e.asRoughSeconds = De),
    (e.asRoughMs = Te),
    (e.wholeDivideDurations = be),
    (e.greatestDurationDenominator = we),
    (e.DateEnv = Do),
    (e.createFormatter = Vt),
    (e.formatIsoTimeString = Bt),
    (e.NamedTimeZoneImpl = Vo),
    (e.parseMarker = ur),
    (e.Interaction = Oo),
    (e.interactionSettingsToStore = Jr),
    (e.interactionSettingsStore = _o),
    (e.ElementDragging = Ao),
    (e.formatDate = ri),
    (e.formatRange = ii),
    (e.globalDefaults = co),
    (e.config = lo),
    ...
    (e.createPlugin = qn),
    (e.DayHeader = Wo),
    (e.computeFallbackHeaderFormat = si),
    (e.renderDateCell = ui),
    (e.DaySeries = Zo),
    (e.sliceEventStore = jt),
    (e.hasBgRendering = Yt),
    (e.getElSeg = Xt),
    (e.DayTable = jo),
    (e.Slicer = Yo),
    (e.applyMutationToEventStore = Qt),
    (e.isPropsValid = pn),
    (e.isInteractionValid = cn),
    (e.EventApi = xi),
    (e.requestJson = Xn),
