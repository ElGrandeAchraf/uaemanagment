...
!(function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        : "function" == typeof define && define.amd
            ...
            : ((e = e || self),
                t((e.FullCalendarTimeGrid = {}), e.FullCalendar, e.FullCalendarDayGrid));
})(this, function (e, t, r) {
    "use strict";
    function i(e, t) {
        function r() {
    ...
    function o(e) {
        ...
        for (t = 0; t < e.length; t++)
            for (r = e[t], i = 0; i < r.length; i++)
                for (n = r[i], n.forwardSegs = [], o = t + 1; o < e.length; o++)
                    a(n, e[o], n.forwardSegs);
    }
    function s(e) {
        var t,
            r,
        ...
        if (void 0 === e.forwardPressure) {
            for (t = 0; t < i.length; t++)
                (r = i[t]), s(r), (n = Math.max(n, 1 + r.forwardPressure));
            e.forwardPressure = n;
        }
    }
    function a(e, t, r) {
    ...
    var u = function (e, t) {
                    ...
                    (r.prototype.renderSegHtml = function (e, r) {
                        ...
                        if ((p.unshift("fc-time-grid-event"), t.isMultiDayRange(s.range))) {
                            if (e.isStart || e.isEnd) {
                                var m = e.start,
                                    g = e.end;
                                (i = this._getTimeText(m, g, d)),
                                    (n = this._getTimeText(m, g, d, this.fullTimeFormat)),
                                    (o = this._getTimeText(m, g, d, null, !1));
                            }
                        } else
        ...
        v = (function (e) {
            function n(r, i, n) {
                ...
                var l = (o.renderColumns = t.memoizeRendering(
                    o._renderColumns,
                    o._unrenderColumns
                ));
                return (
            ...
            return (
                i(n, e),
                    ...
                    (n.prototype.computeDateTop = function (e, r) {
                        return (
                            r || (r = t.startOfDay(e)),
                                this.computeTimeTop(e.valueOf() - r.valueOf())
                        );
                    }),
                        ...
                        if (null != l && null != d) {
                            var c = s.tops[d],
                                ...
                                g = t.addDurations(
                                    ...
                                    t.multiplyDuration(this.snapDuration, f)
                                ),
                                y = n.add(m, g);
                            return {
                                col: l,
                                dateSpan: {
                                    range: { start: y, end: n.add(y, this.snapDuration) },
                                    allDay: !1,
                                },
                                dayEl: this.colEls[l],
                                relativeRect: {
        ...
        C = t.createFormatter({ week: "short" }),
        E = (function (e) {
            function n(i, n, o, s) {
                ...
                return (
                    ...
                    ((a.dayGrid = new r.DayGrid(
                        ...
                        (a.dayGrid.bottomCoordPadding =
                            a.el.querySelector(".fc-divider").offsetHeight)),
                        a
                );
            }
            return (
                i(n, e),
                    ...
                    (n.prototype.computeInitialDateScroll = function () {
                        ...
                        return (r = Math.ceil(r)), r && r++, { top: r };
                    }),
    ...
    var b = (function (e) {
                ...
                i(r, e),
                    ...
                    (r.prototype.render = function (e) {
                        ...
                        this.timeGrid.receiveProps(
                            p({}, this.slicer.sliceProps(e, t, null, this.timeGrid, i), {
                                dateProfile: t,
                                cells: r.cells[0],
                            })
                        );
        ...
        w = (function (e) {
            function n(i, n, o, s) {
                var a = e.call(this, i, n, o, s) || this;
                return (
                    (a.buildDayTable = t.memoize(h)),
                    a.opt("columnHeader") &&
                    (a.header = new t.DayHeader(
                        a.context,
                        a.el.querySelector(".fc-head-container")
                    )),
                        (a.simpleTimeGrid = new b(a.context, a.timeGrid)),
                    a.dayGrid &&
                    ...
                    (n.prototype.render = function (t) {
                        ...
                        this.header.receiveProps({
                            ...
                            this.simpleTimeGrid.receiveProps(
                                p({}, n.timed, { dateProfile: r, dayTable: i })
                            ),
                        this.simpleDayGrid &&
